    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#00a86b] to-[#008f5d] rounded-[2.5rem] p-10 sm:p-14 text-white shadow-2xl shadow-[#00a86b]/20 mb-12 flex items-center justify-between">
        <div className="relative z-10 space-y-8 max-w-xl">
          ...
          <Link href="/pengajuan/baru" className="bg-white text-sipa-green px-8 py-4 rounded-2xl font-black text-lg flex items-center gap-3 shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 active:scale-95 border-none w-fit">
      ...
      <section className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden mb-12 transition-colors duration-300">
                ...
                history.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).map((item, idx) => (
                  <tr key={idx} className="group hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-all duration-300">
                    <td className="px-8 py-8">
                      <span className="text-sm font-black text-slate-800 dark:text-slate-200 group-hover:text-sipa-green transition-colors">
        ...
        <div className="p-8 sm:p-10 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6 transition-colors duration-300">
          ...
          <Link href="/pengajuan" className="group flex items-center gap-3 bg-sipa-green text-white px-10 py-4 rounded-2xl text-xs font-black uppercase tracking-[0.2em] shadow-xl shadow-sipa-green/20 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 active:scale-95">
            LIHAT SEMUA
