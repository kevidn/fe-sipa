      ...
      <div className="space-y-6">
           ...
           <div className="p-8 space-y-6">
              ...
              <div className="space-y-2">
                 ...
                 <CustomSelect 
                    ...
                    onChange={(val) => setSettings({...settings, backup_interval: val})}
                    options={[
                      { value: 'Harian (setiap hari pukul 00:00)', label: 'Harian (setiap hari pukul 00:00)' },
                      { value: 'Mingguan (setiap hari Minggu)', label: 'Mingguan (setiap hari Minggu)' }
                    ]}
                 />
              </div>
           </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-[2rem] shadow-xl shadow-slate-200/50 dark:shadow-slate-950/50 overflow-hidden border border-slate-100 dark:border-slate-800 transition-colors">
           ...
           <div className="p-8 space-y-6">
              ...
              <div className="space-y-2">
                 <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">SMTP Username (Email)</label>
                 <input 
                    type="text" 
              ...
              <div className="space-y-2">
                 ...
                 />
                 <p className="text-[10px] font-bold text-slate-400 mt-1">Gunakan App Password jika menggunakan Gmail.</p>
              </div>
           </div>
        </div>
