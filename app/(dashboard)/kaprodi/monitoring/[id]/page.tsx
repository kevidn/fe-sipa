  ...
  if (!data) {
    return (
      <div className="text-center py-20">
        ...
        <Link href="/kaprodi/monitoring" className="text-sipa-green font-bold mt-4 inline-block">Kembali ke Dashboard</Link>
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/50 space-y-4">
             ...
             <div className="inline-block px-4 py-1.5 rounded-full bg-purple-50 text-purple-600 font-black text-sm whitespace-nowrap text-center min-w-[110px]">
                {data.status}
             </div>
