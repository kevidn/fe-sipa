...
export default function PersetujuanSuratKaprodi() {
  ...
  useBodyScrollLock(showApproveModal || showRejectModal);
                     ...
                     filteredList.map((item) => (
                        <tr key={item.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-all group">
                           ...
                           <td className="px-6 py-6">
                              <div className="font-black text-slate-800 dark:text-slate-200 text-sm mb-1">
                           ...
                           <td className="px-6 py-6">
                              <div className="flex items-center justify-center gap-3">
                                 <Link href={`/kaprodi/persetujuan/${item.id}`} className="w-8 h-8 rounded-full flex items-center justify-center text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-500/10 transition-colors" title="Lihat Detail">
