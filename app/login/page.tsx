              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="w-full pl-14 pr-12 py-4 rounded-2xl bg-slate-50 border-2 border-transparent focus:bg-white focus:border-sipa-green/20 outline-none transition-all font-medium text-slate-600"
                    required
                  />
                  <button 
                    type="button"
