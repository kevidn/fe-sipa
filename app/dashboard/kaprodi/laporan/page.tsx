    ...
    <div className="space-y-6 pb-10">
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-8">
         ...
         <div className="flex items-center gap-3">
            <select 
               className="px-4 py-2.5 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-sm font-bold shadow-sm outline-none cursor-pointer text-slate-700 dark:text-slate-200"
               value={timeRange}
            ...
            <button className="bg-[#00c853] text-white px-5 py-2.5 rounded-xl font-bold text-sm shadow-lg shadow-emerald-500/30 hover:bg-[#00b548] flex items-center gap-2 transition-all active:scale-95">
