...
export default function VerificationPage() {
  ...
  const handleVerify = () => {
    ...
    setTimeout(() => {
      ...
      alert('Pengajuan berhasil diverifikasi dan diteruskan!');
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-6 lg:p-8">
      ...
      <div className="mb-8">
        <Link 
          ...
          className="inline-flex items-center gap-2 text-emerald-600 font-bold text-sm mb-4 hover:gap-3 transition-all"
        >
        ...
        <p className="text-slate-500 dark:text-slate-400 font-medium">Tinjau dan verifikasi dokumen persyaratan pengajuan surat</p>
      </div>
        ...
        <div className="xl:col-span-8 flex flex-col gap-4">
          ...
          <div className="relative aspect-[4/3] bg-slate-900 rounded-[2.5rem] overflow-hidden border border-slate-800 flex flex-col shadow-2xl">
            <div className="flex-1 flex items-center justify-center p-8">
              {/* Mock Document Image */}
              <div className="w-full max-w-2xl bg-white rounded-lg shadow-2xl p-8 animate-in fade-in zoom-in duration-500">
                <div className="flex justify-between items-start mb-8">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-emerald-500 rounded-lg flex items-center justify-center text-white font-bold text-xl">UN</div>
                    <div>
                      <h4 className="text-xs font-black uppercase tracking-tighter text-slate-400">Universitas Negeri Surabaya</h4>
                      <h3 className="text-sm font-bold text-slate-800">KARTU TANDA MAHASISWA</h3>
                    </div>
                  </div>
                </div>
                <div className="flex gap-8">
                  <div className="w-32 h-40 bg-slate-100 rounded-lg flex items-center justify-center">
                    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#cbd5e1" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                  </div>
                  <div className="flex-1 space-y-4">
                    <div>
                      <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Nama</p>
                      <p className="font-bold text-slate-800">Hafiyyan Lintang Arizaki</p>
                    </div>
                    <div>
                      <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">NIM</p>
                      <p className="font-bold text-slate-800">25051204267</p>
                    </div>
                    <div>
                      <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Program Studi</p>
                      <p className="font-bold text-slate-800">Pendidikan Teknologi Informasi</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="xl:col-span-4 space-y-6">
          ...
          <div className="bg-emerald-50 dark:bg-emerald-500/5 rounded-[2.5rem] p-8 border border-emerald-100 dark:border-emerald-500/10">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="font-black text-slate-800 dark:text-white">Verifikasi Pengajuan</h3>
                <p className="text-xs font-bold text-emerald-600">#SKM-2024-125</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-white/60 dark:bg-slate-900/40 rounded-2xl p-4 border border-white dark:border-slate-800">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h4 className="text-xs font-black text-slate-700 dark:text-slate-300 uppercase tracking-widest">Data Mahasiswa</h4>
                </div>
                <div className="space-y-3">
                  <div>
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Nama Lengkap</p>
                    <p className="text-sm font-bold text-slate-800 dark:text-slate-200">Hafiyyan Lintang Arizaki</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">NIM</p>
                      <p className="text-sm font-bold text-slate-800 dark:text-slate-200">25051204267</p>
                    </div>
                    <div>
                      <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Semester</p>
                      <p className="text-sm font-bold text-slate-800 dark:text-slate-200">6 (Enam)</p>
                    </div>
                  </div>
                  <div>
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Program Studi</p>
                    <p className="text-sm font-bold text-slate-800 dark:text-slate-200">Pendidikan Teknologi Informasi</p>
                  </div>
                </div>
              </div>
            </div>
