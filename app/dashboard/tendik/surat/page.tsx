               ...
               <tbody className="divide-y divide-slate-50 dark:divide-slate-800/50">
                  {loading ? (
                     ...
                     <tr key={item.id} className="hover:bg-slate-50/30 dark:hover:bg-slate-800/30 transition-all group">
                        ...
                        <td className="px-8 py-6 text-center">
                           <span className="px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-wider bg-emerald-50 text-emerald-600">
                              {item.status}
                           </span>
                        </td>
                        <td className="px-8 py-6">
           ...
           <div className="relative bg-white dark:bg-slate-900 w-full max-w-lg rounded-[2.5rem] overflow-hidden shadow-2xl transition-colors">
              ...
              <div className="p-10 space-y-6">
                 ...
                 <div className="space-y-2">
                    ...
                    >
                       <option>1-2 hari kerja</option>
                       <option>3-5 hari kerja</option>
                       <option>1-3 hari kerja</option>
                    </select>
                 </div>
                 <div className="space-y-2">
