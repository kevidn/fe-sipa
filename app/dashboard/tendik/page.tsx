    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="bg-white dark:bg-slate-900 p-6 rounded-[2rem] shadow-xl shadow-slate-200/50 dark:shadow-slate-950/50 border border-slate-100 dark:border-slate-800 space-y-4 transition-colors">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <select 
            className="px-6 py-4 rounded-2xl bg-slate-50 dark:bg-slate-800 border-none focus:ring-2 focus:ring-emerald-500/20 font-medium text-slate-600 dark:text-slate-300 cursor-pointer"
            value={filterJenis}
                  ...
                  <tr key={item.id} className="hover:bg-slate-50/30 dark:hover:bg-slate-800/30 transition-colors group">
                    ...
                    <td className="px-8 py-6">
                      <div className="flex gap-2">
                        <Link href={`/dashboard/tendik/pengajuan/${item.id}`} className="text-blue-500 font-bold text-xs hover:underline">Verifikasi</Link>
                        <Link href={`/dashboard/tendik/pengajuan/${item.id}`} className="text-emerald-600 font-bold text-xs hover:underline">Detail</Link>
                      </div>
                    </td>
                  </tr>
                ))
