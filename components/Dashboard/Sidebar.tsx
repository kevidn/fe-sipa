...
const getMenuItems = (role: string) => {
  ...
  if (normalizedRole === 'mahasiswa') {
  ...
  } else if (normalizedRole === 'admin sistem') {
    roleSpecificItems.push(
      { 
        name: 'Dashboard Utama', 
        href: '/admin', 
        icon: (active: boolean) => (
          <svg className={`${active ? 'text-sipa-green' : 'text-slate-400'}`} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            <rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/>
          </svg>
        )
      },
    ...
    roleSpecificItems.push(
      ...
      { 
        name: 'Daftar Pelanggaran SLA', 
        href: '/kaprodi/pelanggaran', 
        icon: (active: boolean) => (
          <svg className={`${active ? 'text-sipa-green' : 'text-slate-400'}`} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
